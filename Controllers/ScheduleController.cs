    ...
    public class ScheduleController : Controller
    {
        ...
        public ActionResult ScheduleUpdate(long scheduleID, string selectedAllSeats,int seatCounter, string startLocation, string endLocation, string coach, int costPerSeat, string numberplate, int inputA1, int inputA2, int inputB1, int inputB2, int inputB3, int inputB4, int inputC1, int inputC2, int inputC3, int inputC4, int inputD1, int inputD2, int inputD3, int inputD4, int inputE1, int inputE2, int inputE3, int inputE4, int inputF1, int inputF2, int inputF3, int inputF4)
        {
            using (AlaskaExpressEntities db = new AlaskaExpressEntities())
            {
                ...
                System.Data.SqlClient.SqlConnection con = new SqlConnection(@"Data SourceDESKTOP-AMGVCS3\SQLEXPRESS;Initial Catalog=AlaskaExpress; Integrated Security=True");
                SqlCommand sql;
                con.Open();
        ...
        public ActionResult Create([Bind(Include = "Schedule_id,Bus_journey_time,Bus_journey_day,A1,A2,B1,B2,B3,B4,C1,C2,C3,C4,D1,D2,D3,D4,E1,E2,E3,E4,F1,F2,F3,F4,Bus_id,Schedule_addedby")] Schedule schedule)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Schedule_id,Bus_journey_time,Bus_journey_day,A1,A2,B1,B2,B3,B4,C1,C2,C3,C4,D1,D2,D3,D4,E1,E2,E3,E4,F1,F2,F3,F4,Bus_id,Schedule_addedby")] Schedule schedule)
        {
            if (ModelState.IsValid)
            {
